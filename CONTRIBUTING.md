...
* **Testing:** Run all smoke tests and regression checks locally (`cargo fmt --all`, `cargo clippy --workspace --all-targets -- -D warnings`, `cargo test --workspace`). We prioritize "Safety First."
